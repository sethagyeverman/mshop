...
type Services struct {
	...
	Inventory     *Services_InventoryService `protobuf:"bytes,2,opt,name=inventory,proto3" json:"inventory,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Services) GetInventory() *Services_InventoryService {
	if x != nil {
		return x.Inventory
	}
	return nil
...
type Services_InventoryService struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Endpoint      string                 `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"` // inventory 服务地址 (例如: "127.0.0.1:9001")
	Timeout       *durationpb.Duration   `protobuf:"bytes,2,opt,name=timeout,proto3" json:"timeout,omitempty"`   // 超时时间
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Services_InventoryService) Reset() {
	*x = Services_InventoryService{}
	mi := &file_conf_conf_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Services_InventoryService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Services_InventoryService) ProtoMessage() {}

func (x *Services_InventoryService) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Services_InventoryService.ProtoReflect.Descriptor instead.
func (*Services_InventoryService) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 1}
}

func (x *Services_InventoryService) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *Services_InventoryService) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\xce\x02\n" +
	"\bServices\x127\n" +
	"\x05goods\x18\x01 \x01(\v2!.kratos.api.Services.GoodsServiceR\x05goods\x12C\n" +
	"\tinventory\x18\x02 \x01(\v2%.kratos.api.Services.InventoryServiceR\tinventory\x1a_\n" +
	"\fGoodsService\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x1ac\n" +
	"\x10InventoryService\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeoutB(Z&mshop/service/order/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Services_InventoryService)(nil), // 9: kratos.api.Services.InventoryService
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.Services.inventory:type_name -> kratos.api.Services.InventoryService
	...
	10, // 13: kratos.api.Services.GoodsService.timeout:type_name -> google.protobuf.Duration
	10, // 14: kratos.api.Services.InventoryService.timeout:type_name -> google.protobuf.Duration
